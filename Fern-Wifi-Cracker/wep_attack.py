...
class wep_window(object):
	...
	font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.injection_work_label.setFont(font)
	...
	font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.cracking_label.setFont(font)
	...
	font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.ivs_progress_label.setFont(font)
	...
	font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.wep_copy_label.setFont(font)
	...
	font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.wep_status_label.setFont(font)
